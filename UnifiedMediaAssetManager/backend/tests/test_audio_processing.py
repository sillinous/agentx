...
class TestTextToSpeech:
    ...
    def test_tts_success(self, client, auth_headers):
    ...
    def test_tts_different_voices(self, client, auth_headers):
    ...
    def test_tts_with_universe(self, client, auth_headers, sample_universe_data):
...
class TestAudioTranscription:
    ...
    def test_transcribe_with_universe(self, client, auth_headers, sample_universe_data):
...
class TestAudioAnalysis:
    ...
    def test_analyze_different_formats(self, client, auth_headers):
...
class TestAudioValidation:
    ...
    def test_tts_missing_text(self, client, auth_headers):
    ...
    def test_transcribe_missing_url(self, client, auth_headers):
    ...
    def test_analyze_invalid_url(self, client, auth_headers):
...
class TestAudioProviders:
    ...
    def test_mock_provider(self, client, auth_headers):
...
class TestAudioJobLifecycle:
    ...
    def test_tts_job_lifecycle(self, client, auth_headers):
    ...
    def test_transcription_job_lifecycle(self, client, auth_headers):
